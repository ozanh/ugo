...
func TestModuleStrings(t *testing.T) {
	...
	ret, err := contains.Call(nil, String("abc"), String("b"))
	require.NoError(t, err)
	require.EqualValues(t, true, ret)
	ret, err = contains.Call(nil, String("abc"), String("d"))
	require.NoError(t, err)
	require.EqualValues(t, false, ret)
	_, err = contains.Call(nil, String("abc"), String("d"), String("x"))
	require.Error(t, err)
	_, err = contains.Call(nil, String("abc"))
	require.Error(t, err)
	_, err = contains.Call(nil)
	require.Error(t, err)

	containsAny := Module["ContainsAny"]
	ret, err = containsAny.Call(nil, String("abc"), String("ax"))
	require.NoError(t, err)
	require.EqualValues(t, true, ret)
	ret, err = containsAny.Call(nil, String("abc"), String("d"))
	require.NoError(t, err)
	require.EqualValues(t, false, ret)

	containsChar := Module["ContainsChar"]
	ret, err = containsChar.Call(nil, String("abc"), Char('a'))
	require.NoError(t, err)
	require.EqualValues(t, true, ret)
	ret, err = containsChar.Call(nil, String("abc"), Char('d'))
	require.NoError(t, err)
	require.EqualValues(t, false, ret)

	count := Module["Count"]
	ret, err = count.Call(nil, String("cheese"), String("e"))
	require.NoError(t, err)
	require.EqualValues(t, 3, ret)
	ret, err = count.Call(nil, String("cheese"), String("d"))
	require.NoError(t, err)
	require.EqualValues(t, 0, ret)

	equalFold := Module["EqualFold"]
	ret, err = equalFold.Call(nil, String("UGO"), String("ugo"))
	require.NoError(t, err)
	require.EqualValues(t, true, ret)
	ret, err = equalFold.Call(nil, String("UGO"), String("go"))
	require.NoError(t, err)
	require.EqualValues(t, false, ret)

	fields := Module["Fields"]
	ret, err = fields.Call(nil, String("\tfoo bar\nbaz"))
	require.NoError(t, err)
	...
	ret, err = hasPrefix.Call(nil, String("foobarbaz"), String("foo"))
	require.NoError(t, err)
	require.EqualValues(t, true, ret)
	ret, err = hasPrefix.Call(nil, String("foobarbaz"), String("baz"))
	require.NoError(t, err)
	require.EqualValues(t, false, ret)

	hasSuffix := Module["HasSuffix"]
	ret, err = hasSuffix.Call(nil, String("foobarbaz"), String("baz"))
	require.NoError(t, err)
	require.EqualValues(t, true, ret)
	ret, err = hasSuffix.Call(nil, String("foobarbaz"), String("foo"))
	require.NoError(t, err)
	require.EqualValues(t, false, ret)

	index := Module["Index"]
	ret, err = index.Call(nil, String("foobarbaz"), String("bar"))
	require.NoError(t, err)
	require.EqualValues(t, 3, ret)
	ret, err = index.Call(nil, String("foobarbaz"), String("x"))
	require.NoError(t, err)
	require.EqualValues(t, -1, ret)

	indexAny := Module["IndexAny"]
	ret, err = indexAny.Call(nil, String("foobarbaz"), String("xz"))
	require.NoError(t, err)
	require.EqualValues(t, 8, ret)
	ret, err = indexAny.Call(nil, String("foobarbaz"), String("x"))
	require.NoError(t, err)
	require.EqualValues(t, -1, ret)

	indexByte := Module["IndexByte"]
	ret, err = indexByte.Call(nil, String("foobarbaz"), Char('z'))
	require.NoError(t, err)
	require.EqualValues(t, 8, ret)
	ret, err = indexByte.Call(nil, String("foobarbaz"), Int('z'))
	require.NoError(t, err)
	require.EqualValues(t, 8, ret)
	ret, err = indexByte.Call(nil, String("foobarbaz"), Char('x'))
	require.NoError(t, err)
	require.EqualValues(t, -1, ret)

	indexChar := Module["IndexChar"]
	ret, err = indexChar.Call(nil, String("foobarbaz"), Char('z'))
	require.NoError(t, err)
	require.EqualValues(t, 8, ret)
	ret, err = indexChar.Call(nil, String("foobarbaz"), Char('x'))
	require.NoError(t, err)
	require.EqualValues(t, -1, ret)

	join := Module["Join"]
	ret, err = join.Call(nil, Array{String("foo"), String("bar")}, String(";"))
	require.NoError(t, err)
	require.EqualValues(t, "foo;bar", ret)

	lastIndex := Module["LastIndex"]
	ret, err = lastIndex.Call(nil, String("zfoobarbaz"), String("z"))
	require.NoError(t, err)
	require.EqualValues(t, 9, ret)
	ret, err = lastIndex.Call(nil, String("zfoobarbaz"), String("x"))
	require.NoError(t, err)
	require.EqualValues(t, -1, ret)

	lastIndexAny := Module["LastIndexAny"]
	ret, err = lastIndexAny.Call(nil, String("zfoobarbaz"), String("xz"))
	require.NoError(t, err)
	require.EqualValues(t, 9, ret)
	ret, err = lastIndexAny.Call(nil, String("foobarbaz"), String("o"))
	require.NoError(t, err)
	require.EqualValues(t, 2, ret)
	ret, err = lastIndexAny.Call(nil, String("foobarbaz"), String("p"))
	require.NoError(t, err)
	require.EqualValues(t, -1, ret)

	lastIndexByte := Module["LastIndexByte"]
	ret, err = lastIndexByte.Call(nil, String("zfoobarbaz"), Char('z'))
	require.NoError(t, err)
	require.EqualValues(t, 9, ret)
	ret, err = lastIndexByte.Call(nil, String("zfoobarbaz"), Int('z'))
	require.NoError(t, err)
	require.EqualValues(t, 9, ret)
	ret, err = lastIndexByte.Call(nil, String("zfoobarbaz"), Char('x'))
	require.NoError(t, err)
	require.EqualValues(t, -1, ret)

	padLeft := Module["PadLeft"]
	ret, err = padLeft.Call(nil, String("abc"), Int(3))
	require.NoError(t, err)
	require.EqualValues(t, "abc", ret)
	ret, err = padLeft.Call(nil, String("abc"), Int(4))
	require.NoError(t, err)
	require.EqualValues(t, " abc", ret)
	ret, err = padLeft.Call(nil, String("abc"), Int(5))
	require.NoError(t, err)
	require.EqualValues(t, "  abc", ret)
	ret, err = padLeft.Call(nil, String("abc"), Int(5), String("="))
	require.NoError(t, err)
	require.EqualValues(t, "==abc", ret)
	ret, err = padLeft.Call(nil, String(""), Int(6), String("="))
	require.NoError(t, err)
	require.EqualValues(t, "======", ret)

	padRight := Module["PadRight"]
	ret, err = padRight.Call(nil, String("abc"), Int(3))
	require.NoError(t, err)
	require.EqualValues(t, "abc", ret)
	ret, err = padRight.Call(nil, String("abc"), Int(4))
	require.NoError(t, err)
	require.EqualValues(t, "abc ", ret)
	ret, err = padRight.Call(nil, String("abc"), Int(5))
	require.NoError(t, err)
	require.EqualValues(t, "abc  ", ret)
	ret, err = padRight.Call(nil, String("abc"), Int(5), String("="))
	require.NoError(t, err)
	require.EqualValues(t, "abc==", ret)
	ret, err = padRight.Call(nil, String(""), Int(6), String("="))
	require.NoError(t, err)
	require.EqualValues(t, "======", ret)

	repeat := Module["Repeat"]
	ret, err = repeat.Call(nil, String("abc"), Int(3))
	require.NoError(t, err)
	require.EqualValues(t, "abcabcabc", ret)
	ret, err = repeat.Call(nil, String("abc"), Int(-1))
	require.NoError(t, err)
	require.EqualValues(t, "", ret)

	replace := Module["Replace"]
	ret, err = replace.Call(nil, String("abcdefbc"), String("bc"), String("(bc)"))
	require.NoError(t, err)
	require.EqualValues(t, "a(bc)def(bc)", ret)
	ret, err = replace.Call(
		nil, String("abcdefbc"), String("bc"), String("(bc)"), Int(1))
	require.NoError(t, err)
	require.EqualValues(t, "a(bc)defbc", ret)

	split := Module["Split"]
	ret, err = split.Call(nil, String("abc;def;"), String(";"))
	require.NoError(t, err)
	require.Equal(t, 3, len(ret.(Array)))
	require.EqualValues(t, "abc", ret.(Array)[0])
	require.EqualValues(t, "def", ret.(Array)[1])
	require.EqualValues(t, "", ret.(Array)[2])
	ret, err = split.Call(nil, String("abc;def;"), String("!"), Int(0))
	require.NoError(t, err)
	require.Equal(t, 0, len(ret.(Array)))
	ret, err = split.Call(nil, String("abc;def;"), String(";"), Int(1))
	require.NoError(t, err)
	require.Equal(t, 1, len(ret.(Array)))
	require.EqualValues(t, "abc;def;", ret.(Array)[0])
	ret, err = split.Call(nil, String("abc;def;"), String(";"), Int(2))
	require.NoError(t, err)
	...
	ret, err = splitAfter.Call(nil, String("abc;def;"), String(";"))
	require.NoError(t, err)
	require.Equal(t, 3, len(ret.(Array)))
	require.EqualValues(t, "abc;", ret.(Array)[0])
	require.EqualValues(t, "def;", ret.(Array)[1])
	require.EqualValues(t, "", ret.(Array)[2])
	ret, err = splitAfter.Call(nil, String("abc;def;"), String("!"), Int(0))
	require.NoError(t, err)
	require.Equal(t, 0, len(ret.(Array)))
	ret, err = splitAfter.Call(nil, String("abc;def;"), String(";"), Int(1))
	require.NoError(t, err)
	require.Equal(t, 1, len(ret.(Array)))
	require.EqualValues(t, "abc;def;", ret.(Array)[0])
	ret, err = splitAfter.Call(nil, String("abc;def;"), String(";"), Int(2))
	require.NoError(t, err)
	require.Equal(t, 2, len(ret.(Array)))
	require.EqualValues(t, "abc;", ret.(Array)[0])
	require.EqualValues(t, "def;", ret.(Array)[1])
	...
	title := Module["Title"]
	ret, err = title.Call(nil, String("хлеб"))
	require.NoError(t, err)
	require.EqualValues(t, "Хлеб", ret)

	toLower := Module["ToLower"]
	ret, err = toLower.Call(nil, String("ÇİĞÖŞÜ"))
	require.NoError(t, err)
	require.EqualValues(t, "çiğöşü", ret)

	toTitle := Module["ToTitle"]
	ret, err = toTitle.Call(nil, String("хлеб"))
	require.NoError(t, err)
	require.EqualValues(t, "ХЛЕБ", ret)

	toUpper := Module["ToUpper"]
	ret, err = toUpper.Call(nil, String("çığöşü"))
	require.NoError(t, err)
	require.EqualValues(t, "ÇIĞÖŞÜ", ret)

	trim := Module["Trim"]
	ret, err = trim.Call(nil, String("!!??abc?!"), String("!?"))
	require.NoError(t, err)
	require.EqualValues(t, "abc", ret)

	trimLeft := Module["TrimLeft"]
	ret, err = trimLeft.Call(nil, String("!!??abc?!"), String("!?"))
	require.NoError(t, err)
	require.EqualValues(t, "abc?!", ret)

	trimPrefix := Module["TrimPrefix"]
	ret, err = trimPrefix.Call(nil, String("abcdef"), String("abc"))
	require.NoError(t, err)
	require.EqualValues(t, "def", ret)

	trimRight := Module["TrimRight"]
	ret, err = trimRight.Call(nil, String("!!??abc?!"), String("!?"))
	require.NoError(t, err)
	require.EqualValues(t, "!!??abc", ret)

	trimSpace := Module["TrimSpace"]
	ret, err = trimSpace.Call(nil, String("\n \tabcdef\t \n"))
	require.NoError(t, err)
	require.EqualValues(t, "abcdef", ret)

	trimSuffix := Module["TrimSuffix"]
	ret, err = trimSuffix.Call(nil, String("abcdef"), String("def"))
	require.NoError(t, err)
	require.EqualValues(t, "abc", ret)
}
